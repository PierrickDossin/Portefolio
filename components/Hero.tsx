  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 bg-black">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/20 via-slate-900 to-black"></div>
        
        {/* Mouse glow effect */}
        <div
          className="absolute w-96 h-96 bg-blue-500/30 rounded-full blur-3xl pointer-events-none transition-all duration-300 ease-out"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-blue-300/80 mb-6"
          >
            Data Engineer
          </motion.p>
          ...
          >
            I build data pipelines and analytics solutions. Currently studying Applied Computer Science at UCLL, 
            with 2 years of hands-on experience in data engineering and full-stack development.
          </motion.p>
        ...
        >
          ...
          >
            <ArrowDown className="text-blue-400/50" size={32} />
          </motion.div>
        </motion.div>
      </div>
    </section>
